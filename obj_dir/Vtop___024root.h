...
class alignas(VL_CACHE_LINE_BYTES) Vtop___024root final : public VerilatedModule {
  public:
    ...
    CData/*0:0*/ top__DOT__my_alu_top__DOT__SrcA;
    CData/*0:0*/ top__DOT__my_alu_top__DOT__SrcB;
    ...
    IData/*31:0*/ top__DOT__my_pc_top__DOT__PC_Plus;
