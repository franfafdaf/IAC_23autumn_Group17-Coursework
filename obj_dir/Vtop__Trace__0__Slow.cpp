...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+69,"ALUResult", false,-1, 31,0);
    ...
    tracep->declBus(c+69,"ALUResult", false,-1, 31,0);
    tracep->declBit(c+66,"Zero", false,-1);
    tracep->declBus(c+70,"SrcA", false,-1, 31,0);
    tracep->declBus(c+71,"SrcB", false,-1, 31,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+63,"RD", false,-1, 31,0);
    tracep->declBus(c+72,"corrected_WD", false,-1, 31,0);
    tracep->declBus(c+73,"read_data_internal", false,-1, 31,0);
    ...
    tracep->declBus(c+77,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBit(c+48,"StSrc", false,-1);
    tracep->declBus(c+68,"WD_i", false,-1, 31,0);
    tracep->declBus(c+72,"WD_o", false,-1, 31,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("my_mem_o ");
    tracep->declBus(c+77,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBit(c+47,"LdSrc", false,-1);
    tracep->declBus(c+73,"RD_i", false,-1, 31,0);
    tracep->declBus(c+63,"RD_o", false,-1, 31,0);
    tracep->popNamePrefix(2);
    ...
    tracep->declBus(c+33,"PC_Plus", false,-1, 31,0);
    tracep->declBus(c+35,"PC", false,-1, 31,0);
    tracep->declBus(c+64,"PC_Target", false,-1, 31,0);
    tracep->declBus(c+60,"PC_Jump", false,-1, 31,0);
    tracep->declBus(c+65,"PC_Next", false,-1, 31,0);
    tracep->popNamePrefix(1);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+37,((0x7fU & vlSelf->top__DOT__Instr)),7);
    bufp->fullCData(oldp+38,((7U & (vlSelf->top__DOT__Instr 
                                    >> 0xcU))),3);
    bufp->fullBit(oldp+39,((1U & (vlSelf->top__DOT__Instr 
                                  >> 0x1eU))));
    ...
    bufp->fullBit(oldp+58,((1U & (vlSelf->top__DOT__Instr 
                                  >> 5U))));
    bufp->fullCData(oldp+59,(((2U & (vlSelf->top__DOT__Instr 
                                     >> 4U)) | (1U 
                                                & (vlSelf->top__DOT__Instr 
                                                   >> 0x1eU)))),2);
    bufp->fullIData(oldp+60,((vlSelf->top__DOT__PC 
                              + vlSelf->top__DOT__ImmExt)),32);
    bufp->fullBit(oldp+61,(((IData)(vlSelf->top__DOT__my_control_unit__DOT__Jump) 
                            | ((((IData)(vlSelf->top__DOT__my_control_unit__DOT__Branch) 
                               ...
                               | (((IData)(vlSelf->top__DOT__my_control_unit__DOT__Branch) 
                                  ...
                                  & (0x1000U == (0x7000U 
                                                 & vlSelf->top__DOT__Instr)))))));
    bufp->fullIData(oldp+62,(((0U == (IData)(vlSelf->top__DOT__ResultSrc))
                               ...
                               : ((1U == (IData)(vlSelf->top__DOT__ResultSrc))
                                   ...
                                   : ((2U == (IData)(vlSelf->top__DOT__ResultSrc))
                                       ? ((IData)(4U) 
                                          + vlSelf->top__DOT__PC)
                                       : 0U)))),32);
    bufp->fullIData(oldp+63,(((IData)(vlSelf->top__DOT__LdSrc)
                               ? (0xffU & vlSelf->top__DOT__my_data_memory__DOT__read_data_internal)
                               : vlSelf->top__DOT__my_data_memory__DOT__read_data_internal)),32);
    bufp->fullIData(oldp+64,(((IData)(vlSelf->top__DOT__JalSrc)
                               ? (vlSelf->top__DOT__PC 
                                  + vlSelf->top__DOT__ImmExt)
                               : vlSelf->top__DOT__RD1)),32);
    bufp->fullIData(oldp+65,((((IData)(vlSelf->top__DOT__my_control_unit__DOT__Jump) 
                               | ((((IData)(vlSelf->top__DOT__my_control_unit__DOT__Branch) 
                                    & (IData)(vlSelf->top__DOT__Zero)) 
                                   & (0U == (0x7000U 
                                             & vlSelf->top__DOT__Instr))) 
    ...
    bufp->fullBit(oldp+66,(vlSelf->top__DOT__Zero));
    bufp->fullIData(oldp+67,(vlSelf->top__DOT__RD1),32);
    bufp->fullIData(oldp+68,(vlSelf->top__DOT__WriteData),32);
    bufp->fullIData(oldp+69,(vlSelf->top__DOT__ALUResult),32);
    bufp->fullIData(oldp+70,(vlSelf->top__DOT__my_alu_top__DOT__SrcA),32);
    bufp->fullIData(oldp+71,(vlSelf->top__DOT__my_alu_top__DOT__SrcB),32);
    bufp->fullIData(oldp+72,(vlSelf->top__DOT__my_data_memory__DOT__corrected_WD),32);
    bufp->fullIData(oldp+73,(vlSelf->top__DOT__my_data_memory__DOT__read_data_internal),32);
