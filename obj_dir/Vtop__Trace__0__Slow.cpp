...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+114,"trigger", false,-1, 31,0);
    ...
    tracep->declBus(c+76,"PC_PlusF", false,-1, 31,0);
    ...
    tracep->declBus(c+78,"A", false,-1, 11,0);
    tracep->declBus(c+42,"A1", false,-1, 4,0);
    tracep->declBus(c+43,"A2", false,-1, 4,0);
    tracep->declBus(c+79,"RDi", false,-1, 31,0);
    ...
    tracep->declBit(c+118,"StallF", false,-1);
    tracep->declBit(c+119,"FlushE", false,-1);
    tracep->declBit(c+1,"FlushD", false,-1);
    tracep->declBus(c+64,"SrcA0E", false,-1, 31,0);
    tracep->declBus(c+65,"SrcB0E", false,-1, 31,0);
    ...
    tracep->declBit(c+112,"clk", false,-1);
    tracep->declBit(c+118,"en", false,-1);
    ...
    tracep->declBus(c+121,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBit(c+112,"clk", false,-1);
    tracep->declBit(c+119,"clr", false,-1);
    tracep->declBit(c+28,"RegWriteD", false,-1);
    tracep->declBus(c+16,"ResultSrcD", false,-1, 1,0);
    tracep->declBit(c+20,"MemWriteD", false,-1);
    tracep->declBit(c+54,"JumpD", false,-1);
    ...
    tracep->declBit(c+37,"LdSrcE", false,-1);
    tracep->declBus(c+51,"ALUResult", false,-1, 31,0);
    tracep->declBus(c+65,"WriteDataE", false,-1, 31,0);
    tracep->declBus(c+59,"RdE", false,-1, 4,0);
    tracep->declBus(c+3,"PC_PlusE", false,-1, 31,0);
    tracep->declBit(c+30,"RegWriteM", false,-1);
    tracep->declBus(c+18,"ResultSrcM", false,-1, 1,0);
    ...
    tracep->declBus(c+51,"ALUResult", false,-1, 31,0);
    tracep->declBit(c+15,"ZeroE", false,-1);
    tracep->declBus(c+66,"SrcAE", false,-1, 31,0);
    tracep->declBus(c+67,"SrcBE", false,-1, 31,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+69,"ALUDecode", false,-1, 1,0);
    tracep->declBit(c+70,"op5", false,-1);
    tracep->popNamePrefix(1);
    ...
    tracep->declBit(c+1,"PCSrcE", false,-1);
    tracep->declBit(c+1,"FlushD", false,-1);
    tracep->declBus(c+71,"ForwardAE", false,-1, 1,0);
    tracep->declBus(c+72,"ForwardBE", false,-1, 1,0);
    tracep->declBit(c+73,"ResultSrcE0", false,-1);
    tracep->declBit(c+118,"lwStall", false,-1);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+76,"PC_PlusF", false,-1, 31,0);
    tracep->declBus(c+77,"PCF", false,-1, 31,0);
    tracep->declBus(c+74,"PC_TargetE", false,-1, 31,0);
    tracep->declBus(c+75,"PC_Jump", false,-1, 31,0);
    ...
    tracep->declBus(c+115,"a0", false,-1, 31,0);
    for (int i = 0; i < 32; ++i) {
        tracep->declBus(c+80+i*1,"register", true,(i+0), 31,0);
    }
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+32,(vlSelf->top__DOT__ALUControlD),3);
    ...
    bufp->fullIData(oldp+64,(vlSelf->top__DOT__SrcA0E),32);
    bufp->fullIData(oldp+65,(vlSelf->top__DOT__SrcB0E),32);
    bufp->fullIData(oldp+66,(vlSelf->top__DOT__my_alu__DOT__SrcAE),32);
    bufp->fullIData(oldp+67,(vlSelf->top__DOT__my_alu__DOT__SrcBE),32);
    bufp->fullCData(oldp+68,(vlSelf->top__DOT__my_control_unit__DOT__ALUOpD),2);
    bufp->fullCData(oldp+69,(((2U & (vlSelf->top__DOT__InstrD 
                                     >> 4U)) | (1U 
                                                & (vlSelf->top__DOT__InstrD 
                                                   >> 0x1eU)))),2);
    bufp->fullBit(oldp+70,((1U & (vlSelf->top__DOT__InstrD 
                                  >> 5U))));
    bufp->fullCData(oldp+71,(vlSelf->top__DOT__my_hazardunit__DOT__ForwardAE),2);
    bufp->fullCData(oldp+72,(vlSelf->top__DOT__my_hazardunit__DOT__ForwardBE),2);
    bufp->fullBit(oldp+73,((1U & (IData)(vlSelf->top__DOT__ResultSrcE))));
    bufp->fullIData(oldp+74,(((IData)(vlSelf->top__DOT__JalSrcE)
                               ? (vlSelf->top__DOT__PCE 
                                  + vlSelf->top__DOT__ImmExtE)
                               : vlSelf->top__DOT__RD1E)),32);
    bufp->fullIData(oldp+75,((vlSelf->top__DOT__PCE 
                              + vlSelf->top__DOT__ImmExtE)),32);
    bufp->fullIData(oldp+76,(((IData)(4U) + vlSelf->top__DOT__PCF)),32);
    ...
    bufp->fullIData(oldp+83,(vlSelf->top__DOT__my_reg_file__DOT__register[3]),32);
    bufp->fullIData(oldp+84,(vlSelf->top__DOT__my_reg_file__DOT__register[4]),32);
    bufp->fullIData(oldp+85,(vlSelf->top__DOT__my_reg_file__DOT__register[5]),32);
    bufp->fullIData(oldp+86,(vlSelf->top__DOT__my_reg_file__DOT__register[6]),32);
    bufp->fullIData(oldp+87,(vlSelf->top__DOT__my_reg_file__DOT__register[7]),32);
    bufp->fullIData(oldp+88,(vlSelf->top__DOT__my_reg_file__DOT__register[8]),32);
    bufp->fullIData(oldp+89,(vlSelf->top__DOT__my_reg_file__DOT__register[9]),32);
    bufp->fullIData(oldp+90,(vlSelf->top__DOT__my_reg_file__DOT__register[10]),32);
    bufp->fullIData(oldp+91,(vlSelf->top__DOT__my_reg_file__DOT__register[11]),32);
    bufp->fullIData(oldp+92,(vlSelf->top__DOT__my_reg_file__DOT__register[12]),32);
    bufp->fullIData(oldp+93,(vlSelf->top__DOT__my_reg_file__DOT__register[13]),32);
    bufp->fullIData(oldp+94,(vlSelf->top__DOT__my_reg_file__DOT__register[14]),32);
    bufp->fullIData(oldp+95,(vlSelf->top__DOT__my_reg_file__DOT__register[15]),32);
    bufp->fullIData(oldp+96,(vlSelf->top__DOT__my_reg_file__DOT__register[16]),32);
    bufp->fullIData(oldp+97,(vlSelf->top__DOT__my_reg_file__DOT__register[17]),32);
    bufp->fullIData(oldp+98,(vlSelf->top__DOT__my_reg_file__DOT__register[18]),32);
    bufp->fullIData(oldp+99,(vlSelf->top__DOT__my_reg_file__DOT__register[19]),32);
    bufp->fullIData(oldp+100,(vlSelf->top__DOT__my_reg_file__DOT__register[20]),32);
    bufp->fullIData(oldp+101,(vlSelf->top__DOT__my_reg_file__DOT__register[21]),32);
    bufp->fullIData(oldp+102,(vlSelf->top__DOT__my_reg_file__DOT__register[22]),32);
    bufp->fullIData(oldp+103,(vlSelf->top__DOT__my_reg_file__DOT__register[23]),32);
    bufp->fullIData(oldp+104,(vlSelf->top__DOT__my_reg_file__DOT__register[24]),32);
    bufp->fullIData(oldp+105,(vlSelf->top__DOT__my_reg_file__DOT__register[25]),32);
    bufp->fullIData(oldp+106,(vlSelf->top__DOT__my_reg_file__DOT__register[26]),32);
    bufp->fullIData(oldp+107,(vlSelf->top__DOT__my_reg_file__DOT__register[27]),32);
    bufp->fullIData(oldp+108,(vlSelf->top__DOT__my_reg_file__DOT__register[28]),32);
    bufp->fullIData(oldp+109,(vlSelf->top__DOT__my_reg_file__DOT__register[29]),32);
    bufp->fullIData(oldp+110,(vlSelf->top__DOT__my_reg_file__DOT__register[30]),32);
    bufp->fullIData(oldp+111,(vlSelf->top__DOT__my_reg_file__DOT__register[31]),32);
    bufp->fullBit(oldp+112,(vlSelf->clk));
    bufp->fullBit(oldp+113,(vlSelf->rst));
    bufp->fullIData(oldp+114,(vlSelf->trigger),32);
    bufp->fullIData(oldp+115,(vlSelf->a0),32);
    bufp->fullIData(oldp+116,(vlSelf->top__DOT__my_reg_file__DOT__register
                              [(0x1fU & (vlSelf->top__DOT__InstrD 
                                         >> 0xfU))]),32);
    bufp->fullIData(oldp+117,(vlSelf->top__DOT__my_reg_file__DOT__register
                              [(0x1fU & (vlSelf->top__DOT__InstrD 
                                         >> 0x14U))]),32);
    bufp->fullBit(oldp+118,(vlSelf->top__DOT__my_hazardunit__DOT__lwStall));
