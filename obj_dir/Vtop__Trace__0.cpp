...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgCData(oldp+31,(vlSelf->top__DOT__ALUControlD),3);
        ...
        bufp->chgIData(oldp+63,(vlSelf->top__DOT__SrcA0E),32);
        bufp->chgIData(oldp+64,(vlSelf->top__DOT__SrcB0E),32);
        bufp->chgIData(oldp+65,(vlSelf->top__DOT__my_alu__DOT__SrcAE),32);
        bufp->chgIData(oldp+66,(vlSelf->top__DOT__my_alu__DOT__SrcBE),32);
        bufp->chgCData(oldp+67,(vlSelf->top__DOT__my_control_unit__DOT__ALUOpD),2);
        bufp->chgCData(oldp+68,(((2U & (vlSelf->top__DOT__InstrD 
                                        >> 4U)) | (1U 
                                                   & (vlSelf->top__DOT__InstrD 
                                                      >> 0x1eU)))),2);
        bufp->chgBit(oldp+69,((1U & (vlSelf->top__DOT__InstrD 
                                     >> 5U))));
        bufp->chgCData(oldp+70,(vlSelf->top__DOT__my_hazardunit__DOT__ForwardAE),2);
        bufp->chgCData(oldp+71,(vlSelf->top__DOT__my_hazardunit__DOT__ForwardBE),2);
        bufp->chgBit(oldp+72,((1U & (IData)(vlSelf->top__DOT__ResultSrcE))));
        bufp->chgIData(oldp+73,(((IData)(vlSelf->top__DOT__JalSrcE)
                                  ? (vlSelf->top__DOT__PCE 
                                     + vlSelf->top__DOT__ImmExtE)
                                  : vlSelf->top__DOT__RD1E)),32);
        bufp->chgIData(oldp+74,((vlSelf->top__DOT__PCE 
                                 + vlSelf->top__DOT__ImmExtE)),32);
    }
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        bufp->chgIData(oldp+75,(((IData)(4U) + vlSelf->top__DOT__PCF)),32);
        bufp->chgIData(oldp+76,(vlSelf->top__DOT__PCF),32);
        bufp->chgSData(oldp+77,((0xfffU & vlSelf->top__DOT__PCF)),12);
        bufp->chgIData(oldp+78,(((vlSelf->top__DOT__my_InstrD_mem__DOT__rom_array
    ...
    if (VL_UNLIKELY((vlSelf->__Vm_traceActivity[3U] 
        ...
        bufp->chgIData(oldp+79,(vlSelf->top__DOT__my_reg_file__DOT__register[0]),32);
        bufp->chgIData(oldp+80,(vlSelf->top__DOT__my_reg_file__DOT__register[1]),32);
        bufp->chgIData(oldp+81,(vlSelf->top__DOT__my_reg_file__DOT__register[2]),32);
        bufp->chgIData(oldp+82,(vlSelf->top__DOT__my_reg_file__DOT__register[3]),32);
        bufp->chgIData(oldp+83,(vlSelf->top__DOT__my_reg_file__DOT__register[4]),32);
        bufp->chgIData(oldp+84,(vlSelf->top__DOT__my_reg_file__DOT__register[5]),32);
        bufp->chgIData(oldp+85,(vlSelf->top__DOT__my_reg_file__DOT__register[6]),32);
        bufp->chgIData(oldp+86,(vlSelf->top__DOT__my_reg_file__DOT__register[7]),32);
        bufp->chgIData(oldp+87,(vlSelf->top__DOT__my_reg_file__DOT__register[8]),32);
        bufp->chgIData(oldp+88,(vlSelf->top__DOT__my_reg_file__DOT__register[9]),32);
        bufp->chgIData(oldp+89,(vlSelf->top__DOT__my_reg_file__DOT__register[10]),32);
        bufp->chgIData(oldp+90,(vlSelf->top__DOT__my_reg_file__DOT__register[11]),32);
        bufp->chgIData(oldp+91,(vlSelf->top__DOT__my_reg_file__DOT__register[12]),32);
        bufp->chgIData(oldp+92,(vlSelf->top__DOT__my_reg_file__DOT__register[13]),32);
        bufp->chgIData(oldp+93,(vlSelf->top__DOT__my_reg_file__DOT__register[14]),32);
        bufp->chgIData(oldp+94,(vlSelf->top__DOT__my_reg_file__DOT__register[15]),32);
        bufp->chgIData(oldp+95,(vlSelf->top__DOT__my_reg_file__DOT__register[16]),32);
        bufp->chgIData(oldp+96,(vlSelf->top__DOT__my_reg_file__DOT__register[17]),32);
        bufp->chgIData(oldp+97,(vlSelf->top__DOT__my_reg_file__DOT__register[18]),32);
        bufp->chgIData(oldp+98,(vlSelf->top__DOT__my_reg_file__DOT__register[19]),32);
        bufp->chgIData(oldp+99,(vlSelf->top__DOT__my_reg_file__DOT__register[20]),32);
        bufp->chgIData(oldp+100,(vlSelf->top__DOT__my_reg_file__DOT__register[21]),32);
        bufp->chgIData(oldp+101,(vlSelf->top__DOT__my_reg_file__DOT__register[22]),32);
        bufp->chgIData(oldp+102,(vlSelf->top__DOT__my_reg_file__DOT__register[23]),32);
        bufp->chgIData(oldp+103,(vlSelf->top__DOT__my_reg_file__DOT__register[24]),32);
        bufp->chgIData(oldp+104,(vlSelf->top__DOT__my_reg_file__DOT__register[25]),32);
        bufp->chgIData(oldp+105,(vlSelf->top__DOT__my_reg_file__DOT__register[26]),32);
        bufp->chgIData(oldp+106,(vlSelf->top__DOT__my_reg_file__DOT__register[27]),32);
        bufp->chgIData(oldp+107,(vlSelf->top__DOT__my_reg_file__DOT__register[28]),32);
        bufp->chgIData(oldp+108,(vlSelf->top__DOT__my_reg_file__DOT__register[29]),32);
        bufp->chgIData(oldp+109,(vlSelf->top__DOT__my_reg_file__DOT__register[30]),32);
        bufp->chgIData(oldp+110,(vlSelf->top__DOT__my_reg_file__DOT__register[31]),32);
    }
    bufp->chgBit(oldp+111,(vlSelf->clk));
    bufp->chgBit(oldp+112,(vlSelf->rst));
    bufp->chgIData(oldp+113,(vlSelf->trigger),32);
    bufp->chgIData(oldp+114,(vlSelf->a0),32);
    bufp->chgIData(oldp+115,(vlSelf->top__DOT__my_reg_file__DOT__register
                             [(0x1fU & (vlSelf->top__DOT__InstrD 
                                        >> 0xfU))]),32);
    bufp->chgIData(oldp+116,(vlSelf->top__DOT__my_reg_file__DOT__register
                             [(0x1fU & (vlSelf->top__DOT__InstrD 
                                        >> 0x14U))]),32);
    bufp->chgBit(oldp+117,(vlSelf->top__DOT__my_hazardunit__DOT__lwStall));
