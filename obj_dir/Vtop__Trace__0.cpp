...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        ...
        bufp->chgIData(oldp+35,((((IData)(vlSelf->__VdfgTmp_h95d868b5__0) 
                                  << 0x18U) | vlSelf->__VdfgTmp_h5b56bba3__0)),32);
        bufp->chgCData(oldp+36,((0x7fU & (IData)(vlSelf->__VdfgTmp_h2214dd4b__0))),7);
        bufp->chgCData(oldp+37,((7U & ((IData)(vlSelf->__VdfgTmp_h23c00ae3__0) 
                                       >> 4U))),3);
        bufp->chgBit(oldp+38,((1U & ((IData)(vlSelf->__VdfgTmp_h95d868b5__0) 
                                     >> 6U))));
        ...
        bufp->chgCData(oldp+50,((0x1fU & (vlSelf->__VdfgTmp_h5b56bba3__0 
                                          >> 0xfU))),5);
        bufp->chgCData(oldp+51,(((0x10U & ((IData)(vlSelf->__VdfgTmp_h95d868b5__0) 
                                           << 4U)) 
                                 | (0xfU & (vlSelf->__VdfgTmp_h5b56bba3__0 
                                            >> 0x14U)))),5);
        bufp->chgCData(oldp+52,((0x1fU & ((IData)(vlSelf->__VdfgTmp_h3a3ab0c8__0) 
                                          >> 7U))),5);
        ...
        bufp->chgBit(oldp+57,((1U & ((IData)(vlSelf->__VdfgTmp_h2214dd4b__0) 
                                     >> 5U))));
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[3U])) {
        ...
        bufp->chgIData(oldp+66,(vlSelf->top__DOT__my_data_memory__DOT__corrected_WD),32);
    }
    ...
    bufp->chgBit(oldp+70,(((IData)(vlSelf->top__DOT__my_control_unit__DOT__Jump) 
                           | ((IData)(vlSelf->top__DOT__my_control_unit__DOT__Branch) 
                              & (((IData)(vlSelf->top__DOT__Zero) 
                                  & (0U == (0x70U & (IData)(vlSelf->__VdfgTmp_h23c00ae3__0)))) 
                                 | ((~ (IData)(vlSelf->top__DOT__Zero)) 
                                    & (0x10U == (0x70U 
    ...
    bufp->chgIData(oldp+73,(((vlSelf->top__DOT__my_data_memory__DOT__my_mem__DOT__data_array
                              [(0x1ffffU & ((IData)(3U) 
                                            + vlSelf->top__DOT__ALUResult))] 
                              << 0x18U) | ((vlSelf->top__DOT__my_data_memory__DOT__my_mem__DOT__data_array
                                            [(0x1ffffU 
                                           ...
                                           | ((vlSelf->top__DOT__my_data_memory__DOT__my_mem__DOT__data_array
                                               ...
                                               << 8U) 
                                              | (IData)(vlSelf->__VdfgTmp_h88913f45__0))))),32);
    bufp->chgIData(oldp+74,(((IData)(vlSelf->top__DOT__JalSrc)
                              ? (vlSelf->top__DOT__ImmExt 
                                 + vlSelf->top__DOT__PC)
                              : vlSelf->top__DOT__RD1)),32);
    bufp->chgIData(oldp+75,((((IData)(vlSelf->top__DOT__my_control_unit__DOT__Jump) 
                              | ((IData)(vlSelf->top__DOT__my_control_unit__DOT__Branch) 
                                 & (((IData)(vlSelf->top__DOT__Zero) 
                                     & (0U == (0x70U 
                                               & (IData)(vlSelf->__VdfgTmp_h23c00ae3__0)))) 
