...
=======
    if (VL_UNLIKELY((vlSelf->__Vm_traceActivity[1U] 
        ...
        bufp->chgIData(oldp+6,(vlSelf->top__DOT__my_reg_file__DOT__mem[0]),32);
        bufp->chgIData(oldp+7,(vlSelf->top__DOT__my_reg_file__DOT__mem[1]),32);
        bufp->chgIData(oldp+8,(vlSelf->top__DOT__my_reg_file__DOT__mem[2]),32);
        bufp->chgIData(oldp+9,(vlSelf->top__DOT__my_reg_file__DOT__mem[3]),32);
        bufp->chgIData(oldp+10,(vlSelf->top__DOT__my_reg_file__DOT__mem[4]),32);
        bufp->chgIData(oldp+11,(vlSelf->top__DOT__my_reg_file__DOT__mem[5]),32);
        bufp->chgIData(oldp+12,(vlSelf->top__DOT__my_reg_file__DOT__mem[6]),32);
        bufp->chgIData(oldp+13,(vlSelf->top__DOT__my_reg_file__DOT__mem[7]),32);
        bufp->chgIData(oldp+14,(vlSelf->top__DOT__my_reg_file__DOT__mem[8]),32);
        bufp->chgIData(oldp+15,(vlSelf->top__DOT__my_reg_file__DOT__mem[9]),32);
        bufp->chgIData(oldp+16,(vlSelf->top__DOT__my_reg_file__DOT__mem[10]),32);
        bufp->chgIData(oldp+17,(vlSelf->top__DOT__my_reg_file__DOT__mem[11]),32);
        bufp->chgIData(oldp+18,(vlSelf->top__DOT__my_reg_file__DOT__mem[12]),32);
        bufp->chgIData(oldp+19,(vlSelf->top__DOT__my_reg_file__DOT__mem[13]),32);
        bufp->chgIData(oldp+20,(vlSelf->top__DOT__my_reg_file__DOT__mem[14]),32);
        bufp->chgIData(oldp+21,(vlSelf->top__DOT__my_reg_file__DOT__mem[15]),32);
        bufp->chgIData(oldp+22,(vlSelf->top__DOT__my_reg_file__DOT__mem[16]),32);
        bufp->chgIData(oldp+23,(vlSelf->top__DOT__my_reg_file__DOT__mem[17]),32);
        bufp->chgIData(oldp+24,(vlSelf->top__DOT__my_reg_file__DOT__mem[18]),32);
        bufp->chgIData(oldp+25,(vlSelf->top__DOT__my_reg_file__DOT__mem[19]),32);
        bufp->chgIData(oldp+26,(vlSelf->top__DOT__my_reg_file__DOT__mem[20]),32);
        bufp->chgIData(oldp+27,(vlSelf->top__DOT__my_reg_file__DOT__mem[21]),32);
        bufp->chgIData(oldp+28,(vlSelf->top__DOT__my_reg_file__DOT__mem[22]),32);
        bufp->chgIData(oldp+29,(vlSelf->top__DOT__my_reg_file__DOT__mem[23]),32);
        bufp->chgIData(oldp+30,(vlSelf->top__DOT__my_reg_file__DOT__mem[24]),32);
        bufp->chgIData(oldp+31,(vlSelf->top__DOT__my_reg_file__DOT__mem[25]),32);
        bufp->chgIData(oldp+32,(vlSelf->top__DOT__my_reg_file__DOT__mem[26]),32);
        bufp->chgIData(oldp+33,(vlSelf->top__DOT__my_reg_file__DOT__mem[27]),32);
        bufp->chgIData(oldp+34,(vlSelf->top__DOT__my_reg_file__DOT__mem[28]),32);
        bufp->chgIData(oldp+35,(vlSelf->top__DOT__my_reg_file__DOT__mem[29]),32);
        bufp->chgIData(oldp+36,(vlSelf->top__DOT__my_reg_file__DOT__mem[30]),32);
        bufp->chgIData(oldp+37,(vlSelf->top__DOT__my_reg_file__DOT__mem[31]),32);
    }
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[3U])) {
