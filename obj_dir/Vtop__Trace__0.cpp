...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgWData(oldp+75,(vlSelf->top__DOT__my_cache__DOT__tag),400);
        bufp->chgWData(oldp+88,(vlSelf->top__DOT__my_cache__DOT__data),2048);
        bufp->chgCData(oldp+152,(vlSelf->top__DOT__my_cache__DOT__lru),8);
        bufp->chgBit(oldp+153,(vlSelf->top__DOT__my_cache__DOT__selectedWay));
        bufp->chgWData(oldp+154,(vlSelf->top__DOT__my_cache__DOT__selectedData),128);
        bufp->chgIData(oldp+158,((vlSelf->top__DOT__ALUResultM 
                                  >> 7U)),25);
        bufp->chgCData(oldp+159,((7U & (vlSelf->top__DOT__ALUResultM 
                                        >> 4U))),3);
        bufp->chgCData(oldp+160,((3U & (vlSelf->top__DOT__ALUResultM 
                                        >> 2U))),2);
        bufp->chgCData(oldp+161,(vlSelf->top__DOT__my_control_unit__DOT__ALUOpD),2);
        bufp->chgCData(oldp+162,(vlSelf->top__DOT__my_control_unit__DOT__ALUDecode),2);
        bufp->chgBit(oldp+163,((1U & (vlSelf->top__DOT__InstrD 
                                      >> 5U))));
        bufp->chgCData(oldp+164,(vlSelf->top__DOT__my_hazardunit__DOT__ForwardAE),2);
        bufp->chgCData(oldp+165,(vlSelf->top__DOT__my_hazardunit__DOT__ForwardBE),2);
        bufp->chgBit(oldp+166,((1U & (IData)(vlSelf->top__DOT__ResultSrcE))));
        bufp->chgIData(oldp+167,(((IData)(vlSelf->top__DOT__JalSrcE)
                                   ? (vlSelf->top__DOT__ImmExtE 
                                      + vlSelf->top__DOT__PCE)
                                   : vlSelf->top__DOT__RD1E)),32);
        bufp->chgIData(oldp+168,((vlSelf->top__DOT__ImmExtE 
                                  + vlSelf->top__DOT__PCE)),32);
    }
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        bufp->chgIData(oldp+169,(vlSelf->top__DOT__my_reg_file__DOT__register[0]),32);
        bufp->chgIData(oldp+170,(vlSelf->top__DOT__my_reg_file__DOT__register[1]),32);
        bufp->chgIData(oldp+171,(vlSelf->top__DOT__my_reg_file__DOT__register[2]),32);
        bufp->chgIData(oldp+172,(vlSelf->top__DOT__my_reg_file__DOT__register[3]),32);
        bufp->chgIData(oldp+173,(vlSelf->top__DOT__my_reg_file__DOT__register[4]),32);
        bufp->chgIData(oldp+174,(vlSelf->top__DOT__my_reg_file__DOT__register[5]),32);
        bufp->chgIData(oldp+175,(vlSelf->top__DOT__my_reg_file__DOT__register[6]),32);
        bufp->chgIData(oldp+176,(vlSelf->top__DOT__my_reg_file__DOT__register[7]),32);
        bufp->chgIData(oldp+177,(vlSelf->top__DOT__my_reg_file__DOT__register[8]),32);
        bufp->chgIData(oldp+178,(vlSelf->top__DOT__my_reg_file__DOT__register[9]),32);
        bufp->chgIData(oldp+179,(vlSelf->top__DOT__my_reg_file__DOT__register[10]),32);
        bufp->chgIData(oldp+180,(vlSelf->top__DOT__my_reg_file__DOT__register[11]),32);
        bufp->chgIData(oldp+181,(vlSelf->top__DOT__my_reg_file__DOT__register[12]),32);
        bufp->chgIData(oldp+182,(vlSelf->top__DOT__my_reg_file__DOT__register[13]),32);
        bufp->chgIData(oldp+183,(vlSelf->top__DOT__my_reg_file__DOT__register[14]),32);
        bufp->chgIData(oldp+184,(vlSelf->top__DOT__my_reg_file__DOT__register[15]),32);
        bufp->chgIData(oldp+185,(vlSelf->top__DOT__my_reg_file__DOT__register[16]),32);
        bufp->chgIData(oldp+186,(vlSelf->top__DOT__my_reg_file__DOT__register[17]),32);
        bufp->chgIData(oldp+187,(vlSelf->top__DOT__my_reg_file__DOT__register[18]),32);
        bufp->chgIData(oldp+188,(vlSelf->top__DOT__my_reg_file__DOT__register[19]),32);
        bufp->chgIData(oldp+189,(vlSelf->top__DOT__my_reg_file__DOT__register[20]),32);
        bufp->chgIData(oldp+190,(vlSelf->top__DOT__my_reg_file__DOT__register[21]),32);
        bufp->chgIData(oldp+191,(vlSelf->top__DOT__my_reg_file__DOT__register[22]),32);
        bufp->chgIData(oldp+192,(vlSelf->top__DOT__my_reg_file__DOT__register[23]),32);
        bufp->chgIData(oldp+193,(vlSelf->top__DOT__my_reg_file__DOT__register[24]),32);
        bufp->chgIData(oldp+194,(vlSelf->top__DOT__my_reg_file__DOT__register[25]),32);
        bufp->chgIData(oldp+195,(vlSelf->top__DOT__my_reg_file__DOT__register[26]),32);
        bufp->chgIData(oldp+196,(vlSelf->top__DOT__my_reg_file__DOT__register[27]),32);
        bufp->chgIData(oldp+197,(vlSelf->top__DOT__my_reg_file__DOT__register[28]),32);
        bufp->chgIData(oldp+198,(vlSelf->top__DOT__my_reg_file__DOT__register[29]),32);
        bufp->chgIData(oldp+199,(vlSelf->top__DOT__my_reg_file__DOT__register[30]),32);
        bufp->chgIData(oldp+200,(vlSelf->top__DOT__my_reg_file__DOT__register[31]),32);
    }
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[3U])) {
        bufp->chgIData(oldp+201,(((IData)(4U) + vlSelf->top__DOT__PCF)),32);
        bufp->chgIData(oldp+202,(vlSelf->top__DOT__PCF),32);
        bufp->chgSData(oldp+203,((0xfffU & vlSelf->top__DOT__PCF)),12);
        bufp->chgIData(oldp+204,(((vlSelf->top__DOT__my_InstrD_mem__DOT__rom_array
                                   [(0xfffU & ((IData)(3U) 
    ...
    bufp->chgIData(oldp+207,(vlSelf->a0),32);
    bufp->chgIData(oldp+208,(vlSelf->top__DOT__my_reg_file__DOT__register
                             [(0x1fU & (vlSelf->top__DOT__InstrD 
                                        >> 0xfU))]),32);
    bufp->chgIData(oldp+209,(vlSelf->top__DOT__my_reg_file__DOT__register
                             [(0x1fU & (vlSelf->top__DOT__InstrD 
                                        >> 0x14U))]),32);
    bufp->chgIData(oldp+210,(((IData)(vlSelf->top__DOT__PCSrcE)
