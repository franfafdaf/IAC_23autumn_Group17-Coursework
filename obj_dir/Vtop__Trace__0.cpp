...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        ...
        bufp->chgCData(oldp+36,((0x7fU & vlSelf->top__DOT__Instr)),7);
        bufp->chgCData(oldp+37,((7U & (vlSelf->top__DOT__Instr 
                                       >> 0xcU))),3);
        bufp->chgBit(oldp+38,((1U & (vlSelf->top__DOT__Instr 
                                     >> 0x1eU))));
        ...
        bufp->chgCData(oldp+52,((0x1fU & (vlSelf->top__DOT__Instr 
                                          >> 7U))),5);
        bufp->chgIData(oldp+53,((vlSelf->top__DOT__Instr 
                                 >> 7U)),25);
        ...
        bufp->chgBit(oldp+57,((1U & (vlSelf->top__DOT__Instr 
                                     >> 5U))));
        bufp->chgCData(oldp+58,(((2U & (vlSelf->top__DOT__Instr 
                                        >> 4U)) | (1U 
                                                   & (vlSelf->top__DOT__Instr 
                                                      >> 0x1eU)))),2);
        bufp->chgIData(oldp+59,((vlSelf->top__DOT__PC 
                                 + vlSelf->top__DOT__ImmExt)),32);
    }
    if (VL_UNLIKELY((vlSelf->__Vm_traceActivity[2U] 
                     | vlSelf->__Vm_traceActivity[3U]))) {
        bufp->chgBit(oldp+60,(((IData)(vlSelf->top__DOT__my_control_unit__DOT__Jump) 
        ...
        bufp->chgIData(oldp+61,(((0U == (IData)(vlSelf->top__DOT__ResultSrc))
                                  ...
                                  : ((1U == (IData)(vlSelf->top__DOT__ResultSrc))
                                      ...
                                      : ((2U == (IData)(vlSelf->top__DOT__ResultSrc))
                                          ? ((IData)(4U) 
                                             + vlSelf->top__DOT__PC)
                                          : 0U)))),32);
        bufp->chgIData(oldp+62,(((IData)(vlSelf->top__DOT__LdSrc)
        ...
        bufp->chgIData(oldp+63,(((IData)(vlSelf->top__DOT__JalSrc)
                                  ? (vlSelf->top__DOT__PC 
                                     + vlSelf->top__DOT__ImmExt)
                                  : vlSelf->top__DOT__RD1)),32);
        bufp->chgIData(oldp+64,((((IData)(vlSelf->top__DOT__my_control_unit__DOT__Jump) 
                                  | ((((IData)(vlSelf->top__DOT__my_control_unit__DOT__Branch) 
                                       & (IData)(vlSelf->top__DOT__Zero)) 
                                      & (0U == (0x7000U 
                                                & vlSelf->top__DOT__Instr))) 
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[3U])) {
        bufp->chgBit(oldp+65,(vlSelf->top__DOT__Zero));
        bufp->chgIData(oldp+66,(vlSelf->top__DOT__RD1),32);
        bufp->chgIData(oldp+67,(vlSelf->top__DOT__WriteData),32);
        bufp->chgIData(oldp+68,(vlSelf->top__DOT__ALUResult),32);
        bufp->chgIData(oldp+69,(vlSelf->top__DOT__my_alu_top__DOT__SrcA),32);
        bufp->chgIData(oldp+70,(vlSelf->top__DOT__my_alu_top__DOT__SrcB),32);
        bufp->chgIData(oldp+71,(vlSelf->top__DOT__my_data_memory__DOT__corrected_WD),32);
        bufp->chgIData(oldp+72,(vlSelf->top__DOT__my_data_memory__DOT__read_data_internal),32);
    }
