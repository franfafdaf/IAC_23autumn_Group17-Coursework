...
VL_ATTR_COLD void Vtop___024root___eval_initial__TOP(Vtop___024root* vlSelf) {
    ...
    VL_READMEM_N(true, 8, 4096, 3217031168, VL_CVT_PACK_STR_NW(3, __Vtemp_1)
...
VL_ATTR_COLD void Vtop___024root___dump_triggers__act(Vtop___024root* vlSelf) {
    ...
    if ((1ULL & vlSelf->__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 0 is active: @(posedge clk or posedge top.reset)\n");
    }
...
VL_ATTR_COLD void Vtop___024root___dump_triggers__nba(Vtop___024root* vlSelf) {
    ...
    if ((1ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 0 is active: @(posedge clk or posedge top.reset)\n");
    }
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__PC_Plus = VL_RAND_RESET_I(32);
    ...
    vlSelf->top__DOT__my_pc_top__DOT__PCNext = VL_RAND_RESET_I(32);
    ...
    for (int __Vi0 = 0; __Vi0 < 32; ++__Vi0) {
        vlSelf->top__DOT__my_alu_top__DOT__myreg_file__DOT__mem[__Vi0] = VL_RAND_RESET_I(32);
    }
    ...
    vlSelf->__VdfgTmp_he75fb472__0 = 0;
    vlSelf->__VdfgTmp_hcd46d522__0 = 0;
    vlSelf->__VdfgTmp_hcd94118c__0 = 0;
    vlSelf->__VdfgTmp_hcc2f3243__0 = 0;
    vlSelf->__VdfgTmp_hcc8bf6ba__0 = 0;
